...
$WPHT_var_array = array(
		WPHT.'_PLUGIN_FILE' => 'henrytrack-plugin.php',
		WPHT.'_PLUGINDIR' =>  dirname(dirname(plugin_dir_path(__FILE__))),
		WPHT.'_PLUGIN_PAGES' =>  dirname(dirname(plugin_dir_path(__FILE__))).'/pages',
		WPHT.'_PLUGIN_TEMPLATES' =>  dirname(dirname(plugin_dir_path(__FILE__))).'/pages/templates',
		WPHT.'_PLUGINDIR_URL' => plugin_dir_url(dirname(dirname(__FILE__))),
		WPHT.'_PLUGIN_PGDIR_URL' => plugin_dir_url(dirname(dirname(__FILE__))).'pages',
		WPHT.'_PLUGIN_TMDIR_URL' => plugin_dir_url(dirname(dirname(__FILE__))).'pages/templates',
		WPHT.'_PLUGIN_IMGDIR_URL' => plugin_dir_url(dirname(dirname(__FILE__))).'pages/images',
		WPHT.'_PLUGIN_CSSDIR_URL' => plugin_dir_url(dirname(dirname(__FILE__))).'pages/css',
		WPHT.'_PLUGIN_JSDIR_URL' => plugin_dir_url(dirname(dirname(__FILE__))).'pages/js',
		WPHT.'_PLUGIN_SPLASHTEMDIR_PATH' =>  dirname(dirname(plugin_dir_path(__FILE__))).'/pages/inc/splashTemplates',
		WPHT.'_PLUGIN_SPLASHTEMDIR_URL' => plugin_dir_url(dirname(dirname(__FILE__))).'pages/inc/splashTemplates',
		WPHT.'_PLUGIN_VIDSKINSDIR_PATH' =>  dirname(dirname(plugin_dir_path(__FILE__))).'/pages/inc/skins',
		WPHT.'_PLUGIN_VIDSKINSDIR_URL' => plugin_dir_url(dirname(dirname(__FILE__))).'pages/inc/skins',
		WPHT.'_INC_DIR' => dirname(plugin_dir_path(__FILE__)),
		WPHT.'_CLS_DIR' => dirname(plugin_dir_path(__FILE__)).'/classes'
);
